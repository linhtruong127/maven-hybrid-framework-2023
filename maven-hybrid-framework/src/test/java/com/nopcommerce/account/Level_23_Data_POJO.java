...
public class Level_23_Data_POJO extends BaseTest {
	...
	public void beforeClass(String browserName) {
		...
		userInfo.setFirstName(getEmailRandom("John"));
		userInfo.setLastName(getEmailRandom("Doe"));
		userInfo.setPassword(getEmailRandom("123456"));
	...
	public void User_03_Login_Success() {
		...
		loginPage.loginToApplication(userInfo);
		...
		Assert.assertEquals(customerPage.getDynamicAttributeValueByID("Email"), userInfo.getEmailAddress());
	}
