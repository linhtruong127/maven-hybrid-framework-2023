...
public class ExtentManager {
	...
	public synchronized static ExtentReports createExtentReports() {
		ExtentSparkReporter reporter = new ExtentSparkReporter(GlobalConstants.PROJECT_PATH + "/extentReport/ExtentReportV5.html");
		...
		extentReports.setSystemInfo("Team", "NopCommerce Automation");
